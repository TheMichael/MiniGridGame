...
Want to host Neural Navigator online for free? See [DEPLOYMENT.md](DEPLOYMENT.md) for detailed guides on:

- **Render** (recommended - easiest deployment)
- **PythonAnywhere** (always-on, no sleep)
- **Fly.io** (advanced, requires Docker)

Quick start with Render:
1. Push code to GitHub
2. Sign up at [render.com](https://render.com)
3. Create new Web Service from your repository
4. Deploy and go live in minutes!

See the deployment guide for complete step-by-step instructions.
